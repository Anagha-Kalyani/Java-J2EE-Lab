...
//import java.awt.event.ActionListener;  import java.util.LinkedList; 
import javax.swing.*; 
...
//{
// Age"); 
int v1=Integer.parseInt(age.getText());  if(v1<18 || v1>35)
{
String age1=JOptionPane.showInputDialog(null,"Enter valid Age"); 
		age.setText(age1);  }
//}
//catch(NumberFormatException e) {
// JOptionPane.showMessageDialog(null, "Invalid entry");  //age.requestFocus(); 
//}
     
  checkSGPA_valid(1,sgpa1);  checkSGPA_valid(2,sgpa2);  checkSGPA_valid(3,sgpa3);  checkSGPA_valid(4,sgpa4);  checkSGPA_valid(5,sgpa5);  checkSGPA_valid(6,sgpa6); 
 checkSGPA_valid(7,sgpa7);  checkSGPA_valid(8,sgpa8); 
float cal_cgpa = calculate_cgpa();  cgpa.setText(Float.toString(cal_cgpa)); 
}
...
stud_list.add(s1); 
	...
	f1.setVisible(false);  f2.setVisible(true);  f2.setSize(500,500);  stud_list_display.setText(" ");  for(Student s:stud_list)
	{
	stud_list_display.append(s.toString()+ "\n"); 
} }
}
float calculate_cgpa() {
float v1 = Float.parseFloat(sgpa1.getText());  float v2 = Float.parseFloat(sgpa2.getText());  float v3 = Float.parseFloat(sgpa3.getText()); 

 float v4 = Float.parseFloat(sgpa4.getText());  float v5 = Float.parseFloat(sgpa5.getText());  float v6 = Float.parseFloat(sgpa6.getText());  float v7 = Float.parseFloat(sgpa7.getText());  float v8 = Float.parseFloat(sgpa8.getText());  return (v1+v2+v3+v4+v5+v6+v7+v8)/8; 
}
...
sgpa.setText(v2);  //sgpa.requestFocus(); 
} }
